...
export const MOCK_HOTEL_CHAINS: HotelChain[] = [
  { id: 1, name: 'Luxor', color: '#FF0000', stocksRemaining: 25 },
  { id: 2, name: 'Tower', color: '#FFFF00', stocksRemaining: 25 },
  { id: 3, name: 'American', color: '#0000FF', stocksRemaining: 25 },
  { id: 4, name: 'Worldwide', color: '#8B4513', stocksRemaining: 25 },
  { id: 5, name: 'Festival', color: '#008000', stocksRemaining: 25 },
  { id: 6, name: 'Imperial', color: '#FFC0CB', stocksRemaining: 25 },
  { id: 7, name: 'Continental', color: '#40E0D0', stocksRemaining: 25 },
];
